...
class mmr_summarize(object):
    ...
    def getBestWords(self, n, scored_words):
        ...
        best_scores = sorted(scored_words)
        #best_scores.sort() # Python3 doesn't work that way
        best_words = []
    ...
    def main(self, n, summary_length, cluster_path):
        ...
        summary = self.makeSummary(0.5, sentences, query, best_sentence, idfs, summary_length)
